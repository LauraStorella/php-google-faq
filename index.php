...
// Creo database faq
//   ---> il db è un array contenente a sua volta degli array
//   ---> gli array "figli" hanno struttura key/value (question:text - answer:text)
    ...
    <div id="main-wrapper">
        ...
        <nav>
          ...
          <div class="menu bottom-menu">
            <ul class="list-unstyled">
              ...
              <li id="menu-tab"><a class="current-link" href="">Domande frequenti</a></li>
            </ul>
          </div>
        </nav>
      </header>
      ...
      <footer>
        <div class="footer-container">
          <!-- Left-menu -->
          <div class="menu footer-menu left float">
            <ul class="list-unstyled">
          ...
          <!-- Right-menu -->
          <div class="menu footer-menu right float">
            <img src="img/globe.png" alt="globe">
            <select name="" id="footer-menu-lang">
